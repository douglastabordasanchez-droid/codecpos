...
/**
 * Conexión de sucursal — visible en TODOS los módulos (TopBar), no solo
 * Alimentos y Bebidas. Complementa el login (usuario/contraseña dice QUIÉN
 * eres; esto dice DÓNDE estás parado ahora mismo):
 *
 ...
 *     está físicamente parado (generado en Electron > Multi-Tienda). Un solo
 *     QR = una sola sucursal, conexión directa uno a uno — no hay una lista
 *     para elegir a mano. El resultado queda guardado en este dispositivo
 *     (sucursalActiva.ts) y de inmediato filtra Vender, Inventario y
 *     Alimentos y Bebidas por igual.
 */
