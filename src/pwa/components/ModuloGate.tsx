...
export function ModuloGate({ modulo, children }: Props) {
  ...
  return (
    <div className="min-h-screen bg-orange-50 flex flex-col items-center justify-center p-6 text-center pb-24">
      <div className="w-14 h-14 rounded-2xl bg-white border border-orange-100 flex items-center justify-center mb-4 shadow-sm">
        <Lock className="w-6 h-6 text-orange-400" />
      </div>
      <h1 className="text-slate-900 font-bold text-lg mb-1">Módulo no disponible</h1>
